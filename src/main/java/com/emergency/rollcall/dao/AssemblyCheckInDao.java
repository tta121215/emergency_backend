...
public interface AssemblyCheckInDao extends JpaRepository<AssemblyCheckIn, Long> {
	...
	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.staffId = :id AND a.emergencySyskey = :activateId")
	List<AssemblyCheckIn> findByStaffId(@Param("id") Long id, @Param("activateId") Long activateId);

	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.emergencySyskey = :id ")
	Page<AssemblyCheckIn> getAllHeadCountReport(@Param("id") Long id, Pageable pageable);

	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.emergencySyskey = :id AND (LOWER(a.name) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.icNumber) LIKE LOWER(CONCAT('%', :params, '%')) "
			+ " OR LOWER(a.type) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.staffNo) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.department) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.contactNumber) LIKE LOWER(CONCAT('%', :params, '%')))")
	Page<AssemblyCheckIn> getAllHeadCountReport(@Param("id") Long id, Pageable pageable,
	...
	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.emergencySyskey = :id AND a.checkInStatus = 1 AND (LOWER(a.name) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.icNumber) LIKE LOWER(CONCAT('%', :params, '%')) "
			+ " OR LOWER(a.type) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.staffNo) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.department) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.contactNumber) LIKE LOWER(CONCAT('%', :params, '%')))")
	List<AssemblyCheckIn> getCheckInList(@Param("id") Long id, @Param("params") String params);
	...
	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.emergencySyskey = :id AND a.checkInStatus = 0")
	List<AssemblyCheckIn> getUnCheckInExcel(@Param("id") Long id);

	@Query("SELECT a FROM AssemblyCheckIn a WHERE a.emergencySyskey = :id AND a.checkInStatus = 0 AND (LOWER(a.name) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.icNumber) LIKE LOWER(CONCAT('%', :params, '%'))"
			+ " OR LOWER(a.type) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.staffNo) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.department) LIKE LOWER(CONCAT('%', :params, '%')) OR LOWER(a.contactNumber) LIKE LOWER(CONCAT('%', :params, '%')))")
	List<AssemblyCheckIn> getUnCheckInExcel(@Param("id") Long id, @Param("params") String params);
	...
	@Query(value = "SELECT ac.* , a.name AS AssemblyName " + "FROM Erc_assembly_check_in ac "
	...
	Page<Map<String, Object>> findCheckedInByEmergencyAndAssembly(
			@Param("emergencyActivateId") Long emergencyActivateId, @Param("assemblyId") Long assemblyId,
			Pageable pageable);
	...
	@Query(value = "SELECT ac.* , a.name AS AssemblyName " + "FROM erc_assembly_check_in ac "
			...
			+ "OR LOWER(ac.staff_no) LIKE LOWER('%' || :params || '%') OR LOWER(ac.contact_number) LIKE LOWER('%' || :params || '%') "
			+ "OR LOWER(ac.department) LIKE LOWER('%' || :params || '%') OR LOWER(ac.type) LIKE LOWER('%' || :params || '%') OR LOWER(a.name) LIKE LOWER('%' || :params || '%')"
	...
	Page<Map<String, Object>> findCheckedInByEmergencyAndAssembly(
			@Param("emergencyActivateId") Long emergencyActivateId, @Param("assemblyId") Long assemblyId,
			Pageable pageable, @Param("params") String params);
	...
	@Query(value = "SELECT ac.* , a.name AS AssemblyName " + "FROM erc_assembly_check_in ac "
			+ "LEFT JOIN Erc_Assembly a ON ac.assembly_point = a.syskey "
			+ "WHERE  ac.emergency_syskey = :emergencyActivateId AND ac.check_in_status = 1 "
			+ "AND ( LOWER(ac.name) LIKE LOWER('%' || :params || '%') "
			+ "OR LOWER(ac.ic_number) LIKE LOWER('%' || :params || '%') "
			+ "OR LOWER(ac.staff_no) LIKE LOWER('%' || :params || '%') OR LOWER(ac.contact_number) LIKE LOWER('%' || :params || '%') "
			+ "OR LOWER(ac.department) LIKE LOWER('%' || :params || '%') OR LOWER(ac.type) LIKE LOWER('%' || :params || '%') OR LOWER(a.name) LIKE LOWER('%' || :params || '%')"
...
//			@Param("emergencyActivateId") Long emergencyActivateId, Pageable pageable);
	...
	@Query(value = "SELECT distinct pdl.NAME AS deptName ,pvp.FULLNAME AS username, pvp.VISITORORVIP AS visitor,pvp.CONTACTNO AS mobileNo ,pvp.COMPANYNAME,pvp.STAFFNO AS staffid,pvp.ICNO AS icnumber, pvp.ID,pvp.email AS Email "
			...
			+ "LEFT JOIN PYM_LOCATION_ACCESS_LOOKUP plal ON PVPL.LOCATION_ACCESS_ID =PLAL.ID " + "WHERE ("
			...
			, nativeQuery = true)
	Page<Map<String, Object>> findUsersNotCheckedInByEmergencyActivate(
			@Param("emergencyActivateId") Long emergencyActivateId, @Param("params") List<String> params,
			Pageable pageable, @Param("doors") List<String> doors, @Param("calendar") String calendar);
	...
	@Query(value = "SELECT distinct pdl.NAME AS deptName ,pvp.FULLNAME AS username, pvp.VISITORORVIP AS visitor,pvp.CONTACTNO AS mobileNo ,pvp.COMPANYNAME,pvp.STAFFNO AS staffid,pvp.ICNO AS icnumber, pvp.ID,pvp.email AS Email "
			...
			, nativeQuery = true)
	Page<Map<String, Object>> findNotCheckIn(@Param("emergencyActivateId") Long emergencyActivateId, Pageable pageable,
			@Param("mainBuilding") List<String> mainBuilding, @Param("search") String search,
			@Param("doors") List<String> doors, @Param("calendar") String calendar);
...
//			@Param("emergencyActivateId") Long emergencyActivateId, Pageable pageable, @Param("params") String params,@Param("mainBuilding") List<String> mainBuilding);
	...
	@Query(value = "SELECT u.*,ac.currenttime AS currenttime,ac.currentdate AS currentdate,a.name AS assembly,v.visitororvip AS visitor,d.name AS deptName "
			+ "FROM PYM_User u " + "LEFT JOIN Erc_assembly_check_in ac ON u.id = ac.staff_id "
			+ "LEFT JOIN Erc_Assembly a ON ac.assembly_point = a.syskey "
			+ "LEFT JOIN PYM_vendor_pass v ON v.icno = u.icnumber AND v.is_active=1 "
			+ "LEFT JOIN PYM_department_lookup d ON d.id = v.department "
			+ "AND ac.emergency_syskey = :emergencyActivateId "
	...
	@Query(value = "SELECT u.*,ac.currenttime AS currenttime,ac.currentdate AS currentdate,a.name AS assembly,v.visitororvip AS visitor,d.name AS deptName "
			...
			+ "OR LOWER(d.name) LIKE LOWER('%' || :params || '%') )", countQuery = "SELECT COUNT(*) FROM PYM_User u "
					+ "LEFT JOIN Erc_assembly_check_in ac ON u.id = ac.staff_id "
					+ "LEFT JOIN Erc_Assembly a ON ac.assembly_point = a.syskey "
					+ "LEFT JOIN PYM_vendor_pass v ON v.icno = u.icnumber AND v.is_active=1 "
					+ "LEFT JOIN PYM_department_lookup d ON d.id = v.department "
	...
	@Query(value = "SELECT u.*,v.visitororvip AS visitor,d.name AS deptName FROM PYM_User u "
			+ "LEFT JOIN Erc_assembly_check_in ac ON u.id = ac.staff_id "
			+ "AND ac.emergency_syskey = :emergencyActivateId "
			+ "LEFT JOIN PYM_vendor_pass v ON v.icno = u.icnumber AND v.is_active=1 "
			+ "LEFT JOIN PYM_department_lookup d ON d.id = v.department "
			+ "WHERE ac.staff_id IS NULL", nativeQuery = true)
	List<Map<String, Object>> findUsersNotCheckedInByExcel(@Param("emergencyActivateId") Long emergencyActivateId);

	@Query(value = "SELECT u.*,v.visitororvip AS visitor,d.name AS deptName FROM PYM_User u "
			+ "LEFT JOIN Erc_assembly_check_in ac ON u.id = ac.staff_id "
			+ "AND ac.emergency_syskey = :emergencyActivateId "
			+ "LEFT JOIN PYM_vendor_pass v ON v.icno = u.icnumber AND v.is_active=1 "
			+ "LEFT JOIN PYM_department_lookup d ON d.id = v.department " + "WHERE ac.staff_id IS NULL "
			+ " AND ( LOWER(u.name) LIKE LOWER('%' || :params || '%') "
			+ "OR LOWER(u.icnumber) LIKE LOWER('%' || :params || '%') OR LOWER(u.passportnumber) LIKE LOWER('%' || :params || '%')"
			+ "OR LOWER(u.staffid) LIKE LOWER('%' || :params || '%') OR LOWER(u.mobileno) LIKE LOWER('%' || :params || '%')"
			+ "OR LOWER(v.visitororvip) LIKE LOWER('%' || :params || '%') OR LOWER(d.name) LIKE LOWER('%' || :params || '%') ) ", nativeQuery = true)
	...
	@Query(value = "SELECT u.*,ac.currenttime AS currenttime,ac.currentdate AS currentdate,a.name AS assembly,v.visitororvip AS visitor,d.name AS deptName "
			...
			+ "AND ac.emergency_syskey = :emergencyActivateId "
			+ "WHERE ac.emergency_syskey = :emergencyActivateId", nativeQuery = true)
	List<Map<String, Object>> findUsersCheckedInByExcel(@Param("emergencyActivateId") Long emergencyActivateId);
...
//			        + "DECODE(:sortDirection, 'ASC', 1, 'DESC', -1) "
	...
	@Query(value = "SELECT distinct pwa.CHECKIN , pwa.CHECKOUT , pdl.NAME , PVP.DEPARTMENT , pvpc.COLLECT_DATE , pvpc.RETURNCARDDATE,pvp.NAMEOFPERSONVISITED ,pvp.FULLNAME, pvp.VISITORORVIP,pvp.CONTACTNO  ,pvp.COMPANYNAME,pvp.STAFFNO,pvp.REASON ,pvp.ID,pwa.DOOR_NAME "
			...
			, nativeQuery = true)
	List<Map<String, Object>> findHeadCount(@Param("params") List<String> params, @Param("doors") List<String> doors,
	...
	@Query(value = "SELECT distinct pwa.CHECKIN , pwa.CHECKOUT , pdl.NAME , PVP.DEPARTMENT , pvpc.COLLECT_DATE , pvpc.RETURNCARDDATE,pvp.NAMEOFPERSONVISITED ,pvp.FULLNAME, pvp.VISITORORVIP,pvp.CONTACTNO  ,pvp.COMPANYNAME,pvp.STAFFNO,pvp.REASON ,pvp.ID,pwa.DOOR_NAME "
			...
			, nativeQuery = true)
	Page<Map<String, Object>> findHeadCountReport(Pageable pageable, @Param("params") List<String> params,
			@Param("doors") List<String> doors, @Param("calendar") String calendar, @Param("search") String search);
